...
import { Home, Book, Mail, Menu, X, ArrowRight, Phone, MapPin, Clock, Facebook, Instagram, Twitter, Youtube } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div  id="about" className="py-12 bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            <h2 className="text-base text-blue-600 font-semibold tracking-wide uppercase h-12">Links</h2>
          </div>
<div className="flex justify-center space-x-6">
            <a href="https://x.com/" className="hover:text-blue-400 transition-colors">
              <Twitter size={24} />
            </a>
            ...
            <a href="https://instagram.com/.s" className="hover:text-blue-400 transition-colors">
              <Instagram size={24} />
            </a>
          </div>
        </div>
